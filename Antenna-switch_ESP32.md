...
![alt text](https://github.com/WaarlandIT/HAM-Radio-Scripts/blob/main/images/AS01.png "AS1")

You can now manage the relays. At the bottom you see a link "Wifi settings", click on that to set your home wifi.

![alt text](https://github.com/WaarlandIT/HAM-Radio-Scripts/blob/main/images/AS02.png "AS2")

Select your SSID and set your password, check the static IP box if you want to set that.

![alt text](https://github.com/WaarlandIT/HAM-Radio-Scripts/blob/main/images/AS03.png "AS3")
